...
async function getMeteoDataBerlin(dateToStart: string, daysToCheck: number) {
    ...
    for (let i: number = 0; i < daysToCheck; ++i) {
        ...
        promiseArray.push(meteo.getCityMaxWeather(date.format("YYYY-MM-DD"), 52.5200, 13.4050));
...
getMeteoDataBerlin('2021-04-15', 100);
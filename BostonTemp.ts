...
async function getMeteoDataBoston(dateToStart: string, daysToCheck: number) {
    ...
    for (let i: number = 0; i < daysToCheck; ++i) {
        ...
        promiseArray.push(meteo.getCityMaxWeather(date.format("YYYY-MM-DD"), 42.3601, 71.0589));
...
getMeteoDataBoston('2021-04-15', 100);